...
export default function VendorNotificationsPage() {
  ...
  const fetchData = useCallback(async () => {
    setLoading(true);
    try {
      const { data } = await vendorApi.get('/vendor/notifications?limit=100');
  ...
  const remove = async (id: string, wasUnread: boolean) => {
    await vendorApi.delete(`/vendor/notifications/${id}`);
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <button onClick={fetchData} className="p-2 rounded-lg hover:bg-gray-100 text-gray-400 transition">
