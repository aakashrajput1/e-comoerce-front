...
import { Loader2, ArrowLeft, Mail, Store, CheckCircle } from 'lucide-react';
...
export default function VendorForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.post('/vendor/auth/forgot-password', { email });
      setSent(true);
    } catch (err: any) {
    ...
    <div className="min-h-screen flex" style={{ background: '#FAEFEF' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[480px] flex-shrink-0 p-12 relative overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/60 text-base">We'll send a reset link to your vendor email.</p>
        </div>
          ...
          {sent ? (
            ...
            <>
              <div className="mb-8">
                ...
                <p className="text-gray-400 text-sm mt-1.5">Enter your vendor email to receive a reset link</p>
              </div>
