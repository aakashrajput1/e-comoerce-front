...
import { Eye, EyeOff, Loader2, CheckCircle, ArrowLeft, ShoppingBag, Sparkles, Shield, Truck } from 'lucide-react';
...
export default function BuyerRegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { data } = await api.post('/buyer/auth/register', form);
      localStorage.setItem('buyer_token', data.token);
      setDone(true);
      setTimeout(() => router.push('/buyer/account'), 2000);
    } catch (err: any) {
  ...
  if (done) return (
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: '#FAEFEF' }}>
      <div className="text-center">
        ...
        <h2 className="text-2xl font-black text-gray-900">Welcome to Bazaar!</h2>
        <p className="text-sm text-gray-500 mt-2">Your account is ready. Redirecting...</p>
      </div>
    </div>
  );
    ...
    <div className="min-h-screen flex" style={{ background: '#FAEFEF' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[480px] flex-shrink-0 p-12 relative overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/60 text-base mb-12">Join millions of happy shoppers on Bazaar.</p>
      ...
      <div className="flex-1 flex flex-col justify-center px-6 py-10 overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 text-sm mt-1.5">Fill in the details below to get started</p>
          </div>
