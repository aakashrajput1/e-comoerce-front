...
import { Loader2, ArrowLeft, Eye, EyeOff, ShoppingBag, CheckCircle } from 'lucide-react';
...
export default function BuyerResetPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await api.patch(`/buyer/auth/reset-password/${token}`, { password: form.password });
      setDone(true);
    ...
    <div className="min-h-screen flex" style={{ background: '#FAEFEF' }}>
      ...
      <div className="hidden lg:flex flex-col justify-between w-[480px] flex-shrink-0 p-12 relative overflow-hidden"
        ...
        <div className="relative z-10">
          ...
          <p className="text-white/60 text-base">Choose something strong and memorable.</p>
        </div>
